...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        imageCountourIRlabel->setScaledContents(true);
        ...
        qsliderUSB2->setMaximum(200);
        qsliderUSB2->setValue(200);
        ...
        qsliderIR1->setMaximum(200);
        qsliderIR1->setValue(1);
        ...
        qsliderIR2->setMaximum(200);
        qsliderIR2->setValue(200);
